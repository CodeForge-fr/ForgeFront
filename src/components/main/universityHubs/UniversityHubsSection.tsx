    ...
    <section className="py-24">
      <div className="max-w-xl mx-auto px-4 md:max-w-4xl lg:max-w-7xl">
        ...
        <div className="flex flex-col gap-y-5 lg:flex-row justify-between items-start mb-20">
          ...
          <p className="text-[#5E6C6A] w-full lg:w-2/5 font-light leading-relaxed">
        ...
        <div className="flex flex-col items-center gap-16">
          ...
          <div className="hidden lg:grid grid-cols-2 md:grid-cols-4 gap-20 place-items-center w-full">
          ...
          {/* Bottom Row - 3 logos */}
          <div className="hidden lg:grid grid-cols-2 md:grid-cols-3 gap-24 place-items-center w-4/5">
